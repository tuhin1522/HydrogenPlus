    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Welcome back to the branch admin panel.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Charts Section (Placeholders for Recharts) */}
            ...
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-foreground">New Student {i}</p>
                    <p className="text-xs text-muted-foreground">Class 10 • Batch A</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              {[1, 2].map((i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-foreground">+$150</span>
                </div>
              ))}
            </div>
          </div>
